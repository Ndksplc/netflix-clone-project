...
const MovieCard: React.FC<MovieCardProps> = ({
  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      <img className="cursor-pointer object-cover transition duration
      shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-full h-[12vw]"
      ...
      shadow-xl rounded-t-md w-full h-[12vw]"
         ...
         <div className="z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md">
          <div className="flex flex-row items-center gap-3">
            ...
            transition hover:bg-neutral-300" onClick={()=>router.push(`/watch/${data?.id}`)}>
